/*
Copyleft (C) 2005-2006 H閘io Perroni Filho
xperroni@yahoo.com
ICQ: 2490863
...
public class ChatterBean extends JApplet  {
	 ...
	 */
	/**
	 * Version class identifier for the serialization engine. Matches the number of
	 * the last revision where the class was created / modified.
	 */
		...
		/* Object initialization */
		{
			...
			ActionListener listener = new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					setText("");
					output.append("你说> " + request + "\n");
					output.append("艾丽丝> " + response + "\n");
				}
			};
	...
	public void init() {
		try {
			...
			parser.parse(getAliceBot(), openStream("context"), openStream("splitters"), openStream("substitutions"),
					openStreams("aiml"));
	...
	/**
	 * Configures this object with a set of properties. 根据传入的配置文件的目录，读取里面添加的各类配置文件
	 * 
	 * @param path
	 *            Path of the properties file.
	 */
