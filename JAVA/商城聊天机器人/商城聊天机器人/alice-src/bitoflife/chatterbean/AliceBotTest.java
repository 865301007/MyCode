...
public class AliceBotTest extends TestCase
{
  ...
  */
  ...
  {
    assertEquals("Nice to meet you, H閘io. :-)", bot.respond("My name is H閘io."));
    assertEquals("H閘io", (String) bot.getContext().property("predicate.name"));
    assertEquals("Thank you, H閘io.", bot.respond("Nice to meet you, too."));
